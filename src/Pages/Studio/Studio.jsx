...
function Studio() {
  return (
    <Fade triggerOnce duration={1500} delay={500}>
      <div className="studio">
        <h1 className="title">Multiverse Studio To the Rescue</h1>
        <div className="text-div">
          <p className="desc">
            With our quick onboarding process we seamlessly assign an
            experienced project manager who will work with the client on
            discovery to build out a proper team.
          </p>
        </div>
